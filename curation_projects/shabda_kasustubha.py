...
def get_dict(browser, outfile_path, start_nodes=["अ--उह्र", "अ--अग्निनक्षत्र"]):
    parankusha.click_link_by_text(browser=browser, element_text="विद्यास्थानानि")
    parankusha.click_link_by_text(browser=browser, element_text="संस्कृत-कन्नड-कोशः")
    parankusha.click_link_by_text(browser=browser, element_text="शब्दार्थ-कौस्तुभः")
